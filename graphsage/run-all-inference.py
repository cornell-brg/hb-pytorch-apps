...
for i in range(len(route)):
    ...
    name = "graphsage_hb_inference_%d" % i
    sh_cmd = "mkdir -p " + name
    print(sh_cmd)
    os.system(sh_cmd)
    ...
    # create run script
    script = "(source /home/zz546/venvs/cosim-pytorch/bin/activate; source /work/global/lc873/work/sdh/playground/bigblade-04-01/bsg_bladerunner/setup.sh; cd " + name + "; pycosim.profile /work/global/zz546/hb-pytorch-apps/graphsage/graphsage_cosim.py > out.std 2>&1)"
