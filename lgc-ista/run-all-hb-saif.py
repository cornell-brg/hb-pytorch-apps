...
for i in range(len(route)): # embedding_back
  ...
  # create run script
  script = "(source /home/zz546/venvs/cosim-pytorch/bin/activate; source /work/global/zz546/xcel-bigblade-04-01/setup.sh; cd " + name + "; pycosim.saif /home/zz546/hb-pytorch-apps/lgc-ista/lgc_ista.py  > out.std 2>&1;  gzip run.saif;)"
