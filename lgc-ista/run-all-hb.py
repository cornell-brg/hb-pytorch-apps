...
for i in range(len(route)): # embedding_back
  ...
  # create run script
  script = "(source /home/zz546/venvs/cosim-pytorch/bin/activate; source /work/global/lc873/work/sdh/playground/bigblade-04-01/bsg_bladerunner/setup.sh; cd " + name + "; pycosim.profile /home/zz546/hb-pytorch-apps/lgc-ista/lgc_ista.py > out.std 2>&1)"
