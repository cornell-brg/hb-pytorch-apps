...
for i in range(len(route)):
  ...
  # create run script
  script = "(source /work/global/lc873/work/sdh/venv_cosim/bin/activate; source /work/global/lc873/work/sdh/playground/bsg_bladerunner/setup.sh; pycosim /work/global/lc873/work/sdh/phase2-eval/recsys/hb-pytorch-apps/recsys/recsys.py --nbatch 1 --training > out.std 2>&1)\n"
